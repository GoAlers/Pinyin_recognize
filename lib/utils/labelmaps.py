...
def get_vocabulary(voc_type, EOS='EOS', PADDING='PADDING', UNKNOWN='UNKNOWN'):
  ...
  '''
  voc = None
  types = ['LOWERCASE', 'ALLCASES', 'ALLCASES_SYMBOLS','HYPY']
  ...
  #   voc = hypy.alphabet()
    ...
    raise KeyError('vocls_type must be one of "LOWERCASE", "ALLCASES", "ALLCASES_SYMBOLS"')
