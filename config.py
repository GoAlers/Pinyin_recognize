...
parser.add_argument('--test_data_dir', type=str, metavar='PATH',
                    default=r'./test300')
# parser.add_argument('--synthetic_train_data_dir', nargs='+', type=str, metavar='PATH',
#                     default=[r'./trainnum100'])
# #测试集路径
# parser.add_argument('--test_data_dir', type=str, metavar='PATH',
#                     default=r'./testnum100')
parser.add_argument('--real_train_data_dir', type=str, metavar='PATH',
                    default='./demo_data/zhui/benchmark/cocotext_trainval')
...
parser.add_argument('--voc_type', type=str, default='ALLCASES',
                    choices=['LOWERCASE', 'ALLCASES', 'ALLCASES_SYMBOLS','HYPY'])
...
parser.add_argument('--aug', action='store_true', default=False,
                    help='whether use demo_data augmentation.')
parser.add_argument('--lexicon_type', type=str, default='0', choices=['0', '50', '1k', 'full'],
                    help='which lexicon associated to image is used.')
parser.add_argument('--image_path', type=str, default='',  #demo.py测试图片路径
                    help='the path of single image, used in yzm_demo.py.')
...
# training configs
parser.add_argument('--resume', type=str, default='', metavar='PATH')   #预训练模型存放路径
...
parser.add_argument('--logs_dir', type=str, metavar='PATH',
                    default=osp.join(working_dir, 'ATT_PY/logs300'))   #此处存日志存放路径
